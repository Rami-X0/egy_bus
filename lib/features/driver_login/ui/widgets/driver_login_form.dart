...
class _DriverLoginFormState extends State<DriverLoginForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<DriverLoginCubit>().formKey,
      child: Column(
        children: [
          AppTextFormField(
            textTopFailed: 'User Name',
            keyboardType: TextInputType.text,
            controller: context.read<DriverLoginCubit>().userNameController,
          ...
          AppTextFormField(
            ...
            controller: context.read<DriverLoginCubit>().passwordController,
