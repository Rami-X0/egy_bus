...
class PassengerSignUpForm extends StatefulWidget {
  const PassengerSignUpForm({super.key});

  @override
  State<PassengerSignUpForm> createState() => _PassengerSignUpFormState();
}

class _PassengerSignUpFormState extends State<PassengerSignUpForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<PassengerSignUpCubit>().formKey,
      child: Column(
        children: [
          AppTextFormField(
            textTopFailed: 'Full Name',
            keyboardType: TextInputType.text,
            controller: context.read<PassengerSignUpCubit>().fullNameController,
          ...
          AppTextFormField(
            ...
            keyboardType: TextInputType.text,
            controller: context.read<PassengerSignUpCubit>().userNameController,
          ...
          AppTextFormField(
            ...
            controller: context.read<PassengerSignUpCubit>().emailController,
          ...
          AppTextFormField(
            ...
            controller: context.read<PassengerSignUpCubit>().numberController,
          ...
          AppTextFormField(
            ...
            controller: context.read<PassengerSignUpCubit>().passwordController,
